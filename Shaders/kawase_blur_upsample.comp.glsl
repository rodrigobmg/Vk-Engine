...
layout(local_size_x=Kawase_Bur_Compute_Work_Group_Size, local_size_y=Kawase_Bur_Compute_Work_Group_Size) in;
...
void main() {
    ...
    float4 color = UpsampleTent9(u_src_texture, src_coords, 1 / float2(src_size));
