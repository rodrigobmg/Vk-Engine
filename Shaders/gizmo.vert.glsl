...
layout(location=1) out float3 out_viewpoint_direction;
layout(location=2) out float3 out_position;
layout(location=3) out float3 out_normal;
layout(location=4) out float4 out_color;
layout(location=5) out float out_shaded;
